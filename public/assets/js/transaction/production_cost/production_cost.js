            ...
            data.forEach(function(item) {
                html += `
                    <tr>
                        ...
                        <td class="text-right">${formatNumber(item.val_material_cost)}</td>
                        <td class="text-right">${formatNumber(item.val_process_cost)}</td>
                        <td class="text-right">${formatNumber(item.val_production_cost)}</td>
