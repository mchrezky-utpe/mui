    ...
    x-data="{
        ...
        selectEditMainData(id) {
            ...
            this.formMain = {
                ...
                mst_sku_process_type_id: mainData.mst_sku_process_type_id
            }
                ...
                >
                    ...
                    <tbody class="tw-divide-y tw-divide-gray-200">
                        ...
                        <tr class="tr">
                            ...
                            <td class="tw-px-3 tw-py-2">
                                {{ $main_data->process_type->description ?? "-" }}
                            </td>
                            <td class="tw-px-3 tw-py-2">
        ...
        >
            ...
            >
                ...
                <div>
                    ...
                    <select
                        x-model="formMain.mst_sku_process_type_id"
