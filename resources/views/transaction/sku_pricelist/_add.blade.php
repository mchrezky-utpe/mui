  <!-- Modal -->
  <x-modals.modal id="add_modal" title="Add Production Material Item Price" modalClass="custom-modal-dialog-large" >
                        <!-- Form Section -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="table-container">
                                    <table id="table-item-production" class="table table-striped table-hover">
