    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h2 class="pageheader-title">Production Cost</h2>
...
<!-- MODAL --> 
 ...
 <script src="{{ asset('assets/js/transaction/production_cost/production_cost.js') }}" type="text/javascript"></script> 
 @endsection