<meta name="csrf-token" content="{{ csrf_token() }}"> @extends('template.main')
@section('extra-css')
    @include('transaction.bom.css')
@endsection
@section('content')
    <style>
        .table-container {
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="d-block">Is Priority</label>
                                <div class="form-check">
                                    <input name="flag_main_priority" type="checkbox" class="form-check-input"
                                        id="priorityCheck" style="width: 20px; height: 20px; cursor: pointer;">
                            ...
                            <div class="form-group" style="margin-top: 44px;">
                                <button type="button" id="applyBtn" class="btn btn-sm btn-primary">Apply</button>
                                <button type="button" class="btn btn-sm btn-danger" id="resetBtn">Reset</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="tree-container ml-3">
                            <h4>Result</h4>
                            <div id="treeView" class="my-3">
                                <p></p>
                            </div>
                        </div>
                    </div>
