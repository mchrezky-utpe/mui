            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <ul class="nav nav-tabs px-3 pt-3" id="pmrTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="tab-request" data-toggle="tab" href="#tab-request-content"
                                role="tab">
                                📦 Customer Delivery Schedule
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-second" data-toggle="tab" href="#tab-second-content"
                                role="tab">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab-request-content" role="tabpanel">
                            <div class="card-header">
                                <div class="row w-100 mb-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="cust_delivery_num" id="cust_delivery_num"
                                            class="form-control" placeholder="Cust Delivery Num">
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="table_sales_order_list_selected"
                                ...
                                <div class="text-right mt-3">
                                    <button class="btn btn-outline-success" id="btnImportCDS">
                                        📥 Import CDS
                                    </button>
                        ...
                        <!-- TAB 2 -->
                        <div class="tab-pane fade" id="tab-second-content" role="tabpanel">
                            <div class="card-header">
                                <div class="row w-100 align-items-end">
                                    <div class="col-md-3">
                                        <label>Customer</label>
                                        <select name="customer_delivery_schedule_details"
                                            id="customer_delivery_schedule_details" class="form-control">
                                            <option value="">-- Select Customer --</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Valid From</label>
                                        <input type="date" name="valid_from_customer_delivery_schedule_details"
                                            id="valid_from_customer_delivery_schedule_details" class="form-control"
                                            value="{{ date('Y-m-d') }}">
                                    </div>
                                    <div class="col-md-3">
                                        <label>Valid Until</label>
                                        <input type="date" name="valid_until_customer_delivery_schedule_details"
                                            id="valid_until_customer_delivery_schedule_details" class="form-control"
                                            min="{{ date('Y-m-d') }}" value="{{ date('Y-m-d') }}" disabled>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="table_customer_delivery_schedule"
                                        class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                <th>CDS Code</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="modal_delivery_date" class="form-control" min="{{ date('Y-m-d') }}">
                </div>
...
<div class="modal fade" id="modalImport" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Import CDS</h5>
                <button type="button" class="close" data-bs-dismiss="modal">&times;</button>
            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" id="btnSaveImport">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script src="{{ asset('assets/js/transaction/Inventory/customer_delivery_schedule/customer_delivery_schedule.js') }}"
