<x-modals.modal id="add_modal" title="Add Inventory Sales Return">
<form id="form_modal" autocomplete="off" class="form-horizontal" method="post" action="/inventory-sales-return">
    @csrf
