<x-modals.modal id="add_modal" title="Add Inventory Material Request">
<form id="form_modal" autocomplete="off" class="form-horizontal" method="post" action="/inventory-material-req">
    @csrf
