<x-modals.modal id="add_modal" title="Add Inventory Receiving">
<form id="form_modal" autocomplete="off" class="form-horizontal" method="post" action="/inventory-receiving">
    @csrf
