    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h2 class="pageheader-title">SKU Min Of Stock</h2>
          <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Min Of Stock</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <div class="table-responsive">
              <table class="table data-table table-striped table-bordered first">
                ...
                <tbody> @foreach($data as $key => $value) <tr>
                    ...
                    <td>{{ $value->qty }}</td>
                    <td>
                      <form action="/sku-minofstock/{{ $value->id }}/delete" method="post"> @csrf 
...
<!-- MODAL --> 
 @include('transaction.sku_minofstock._add') 
 @include('transaction.sku_minofstock._edit') 
 @endsection 
 
 @section('extra_javascript') 
 <script src="{{ asset('assets/js/transaction/sku_minofstock.js') }}" type="text/javascript"></script> 
 @endsection