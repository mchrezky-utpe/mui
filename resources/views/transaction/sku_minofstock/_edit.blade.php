<x-modals.modal id="edit_modal" title="Edit Sku Min Of Stock">
<form id="form_modal" autocomplete="off" class="form-horizontal" method="post" action="/sku-minofstock/edit">
    @csrf
