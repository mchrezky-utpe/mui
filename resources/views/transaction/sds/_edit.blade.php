<x-modals.modal id="edit_modal" title="Edit Sds" modalClass="custom-modal-dialog-medium">
<form id="form_modal" autocomplete="off" class="form-horizontal" method="post" action="/sds/edit">
    @csrf 
     <!-- TAB TRANSACTION -->
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input required name="trans_date" class="form-control" type="date" >
        </div>
      </div>
      <!-- REGION SIDE 2 -->
      <div class="col-md-4">
