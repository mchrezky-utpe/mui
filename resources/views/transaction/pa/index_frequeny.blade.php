    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Purchase Analysis - Frequency</h2>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Purchase Frequeny</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="tab-content p-4" id="dashboardTabsContent">
            <!-- Tab 1 Content -->
                ...
                <div id="tab1Content">
                    @include('transaction.pa._purchase_frequency')
                </div>
        </div>
    </div>
</div>
...
<script type="module" src="{{ asset('assets/js/transaction/purchase_analysis/pa_frequency_main.js') }}" type="text/javascript"></script>
@endsection