<x-modals.modal id="edit_modal" title="Edit Inventory Receiving">
<form id="form_modal" autocomplete="off" class="form-horizontal" method="post" action="/inventory-receiving/edit">
    @csrf
