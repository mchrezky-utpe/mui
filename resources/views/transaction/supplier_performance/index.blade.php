    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Supplier Pefrormane</h2>
        ...
        <div class="tab-content p-4" id="dashboardTabsContent">
            <!-- Tab 1 Content -->
                ...
                <div id="tab1Content">
                    @include('transaction.supplier_performance._detail')
                </div>
        </div>
    </div>
</div>
...
<script type="module" src="{{ asset('assets/js/transaction/supplier_performance/supplier_performance_main.js') }}" type="text/javascript"></script>
@endsection