    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h2 class="pageheader-title">Internal</h2>
...
<!-- MODAL -->
 @include('transaction.receiving.internal._add') 
 @include('transaction.receiving.internal._edit') 
 @include('transaction.receiving.internal._qty_sds') 
 @include('transaction.receiving.internal._reschedule') 
 @endsection 
