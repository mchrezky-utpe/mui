    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h2 class="pageheader-title">Returnable Packaging</h2>
          <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Returnable Packaging</li>
              </ol>
            </nav>
          </div>
        </div>
...
<!-- MODAL -->
 @include('transaction.receiving.returnable_packaging._add') 
 @include('transaction.receiving.returnable_packaging._edit') 
 @include('transaction.receiving.returnable_packaging._qty_sds') 
 @include('transaction.receiving.returnable_packaging._reschedule') 
 @endsection 
