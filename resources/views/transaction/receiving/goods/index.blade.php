    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h3 class="pageheader-title">Goods received</h3>
        </div>
      </div>
    </div>
...
<script type="module" src="{{ asset('assets/js/transaction/Inventory/goods/goods_received_main.js') }}" type="text/javascript"></script> 
@endsection