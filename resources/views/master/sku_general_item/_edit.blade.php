<x-modals.modal id="edit_modal" title="Edit Part Information" modalClass="custom-modal-dialog-medium">
<form id="form_modal" autocomplete="off" class="form-horizontal" method="post" action="/sku-general-item/edit">
<div class="row">  
@csrf
