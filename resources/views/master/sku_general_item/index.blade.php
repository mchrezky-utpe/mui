                    ...
                    >
                        ...
                        <div class="d-flex">
                            <button
                                id="add_button"
                                type="button"
                                class="btn btn-primary btn_general_item"
                                data-toggle="modal"
                            ...
                            <a
                                href="{{ route('sku.export_general_item') }}"
                            ...
                            <table class="table data-table-item table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form
                                                action="/sku-general-item/{{ $value->id }}/delete"
                                                method="post"
                                            >
                                                @csrf
                                                <div class="d-flex">
...
@include('master.sku_general_item._edit') @endsection
@section('extra_javascript')
<script
    src="{{ asset('assets/js/master/sku_general_item.js') }}"
