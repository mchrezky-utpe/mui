<x-modals.modal id="edit_modal" title="Edit Factory Machine">
<form id="form_modal" autocomplete="off" class="form-horizontal" method="post" action="/factory-machine/edit">
    @csrf
