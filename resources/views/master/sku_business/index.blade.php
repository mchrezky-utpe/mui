            ...
            <div class="table-responsive">
              <table class="table data-table table-striped table-bordered first">
                ...
                <tbody> @foreach($data as $key => $value) <tr>
                    ...
                    <td>
                      <form action="/sku-business/{{ $value->id }}/delete" method="post"> @csrf 
...
<!-- MODAL --> 
 @include('master.sku_business._add') 
 @include('master.sku_business._edit') 
 @endsection 
 
 @section('extra_javascript') 
 <script src="{{ asset('assets/js/master/sku_business.js') }}" type="text/javascript"></script> 
 @endsection