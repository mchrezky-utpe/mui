          ...
          <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Production Material</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">List</h5>
              <div class="d-flex">
              <button id="add_button" type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_modal">+ Production Material</button>
              <a href="{{ route('sku.export_production_material') }}" class="mr-2 btn btn-success">
            ...
            <div class="table-responsive">
              <table class="table data-table table-striped table-bordered first">
                ...
                <tbody> @foreach($data as $key => $value) <tr>
                    ...
                    <td>
                      <form action="/sku-production-material/{{ $value->id }}/delete" method="post"> @csrf 
                      <div class="d-flex">
...
<!-- MODAL --> 
 ...
 @include('master.sku_production_material._edit') 
 @endsection 
 
 @section('extra_javascript') 
 <script src="{{ asset('assets/js/master/sku_production_material.js') }}" type="text/javascript"></script> 
 @endsection