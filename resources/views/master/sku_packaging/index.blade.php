    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h2 class="pageheader-title">SKU Packaging</h2>
            ...
            <div class="table-responsive">
              <table class="table data-table table-striped table-bordered first">
                ...
                <tbody> @foreach($data as $key => $value) <tr>
                    ...
                    <td>
                      <form action="/sku-packaging/{{ $value->id }}/delete" method="post"> @csrf 
...
<!-- MODAL --> 
 @include('master.sku_packaging._add') 
 @include('master.sku_packaging._edit') 
 @endsection 
 
 @section('extra_javascript') 
 <script src="{{ asset('assets/js/master/sku_packaging.js') }}" type="text/javascript"></script> 
 @endsection