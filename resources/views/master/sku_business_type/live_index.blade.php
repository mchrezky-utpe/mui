...
>
    ...
    <div class="tw-px-2 tw-py-2 sm:tw-px-6 tw-grid tw-gap-6">
        ...
        >
            ...
            <!-- Form Search -->
            <form wire:submit.prevent="getData" class="tw-px-4 tw-py-3">
                <div
            ...
            >
                ...
                <div
                    wire:loading
                    wire:target="getData,addData,editData,deleteData"
                            ...
                            <td class="tw-px-3 tw-py-2">
                                <div class="tw-flex tw-justify-center tw-gap-2">
                                    ...
                                    >
                                        <button
                                            type="button"
                                            x-on:click="selectEditMainData({{ $business->id }})"
                                            class="action-edit tw-p-1.5 tw-rounded tw-text-blue-600 hover:tw-bg-blue-100 focus:tw-outline-none"
                                        >
                                            <svg
                                                class="tw-h-4 tw-w-4"
                                                viewBox="0 0 24 24"
            ...
            <div class="tw-px-4 tw-py-3">
                {{ $main_data->links('vendor.pagination.tw-custom') }}
            </div>
        </section>
    </div>
