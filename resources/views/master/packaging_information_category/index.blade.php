...
<!-- MODAL --> 
 @include('master.packaging_information_category._add') 
 @include('master.packaging_information_category._edit') 
 @endsection 
 
 @section('extra_javascript') 
 <script src="{{ asset('assets/js/master/packaging_information_category.js') }}" type="text/javascript"></script> 
 @endsection