<x-modals.modal id="edit_modal" title="Edit Factory Warehouse">
<form id="form_modal" autocomplete="off" class="form-horizontal" method="post" action="/factory-warehouse/edit">
    @csrf
