@extends('template.main') @section('content') <div class="section__content section__content--p30">
      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="page-header">
            <h2 class="pageheader-title">General Tax Deleted Items</h2>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                  <a href="/general-tax"  class="btn btn-primary">list active</a>
                </div>
              </div>
            <div class="card-body">
                  ...
                  <tbody> @foreach($data as $key => $value) <tr>
                      ...
                      <td>
                        <div class="inline d-flex">
                            <form action="/general-tax/{{ $value->id }}/restore" method="post" onsubmit="return confirm('Yakin ingin mengembalikan item ini?')">
                              @csrf
                              <!-- Tombol Hapus -->
                            ...
                            <form action="/general-tax/{{ $value->id }}/hapus" method="post" onsubmit="return confirm('Yakin ingin menghapus item ini?')">
                              @csrf
                              <!-- Tombol Hapus -->
   ...
   <script src="{{ asset('assets/js/master/general_tax.js') }}" type="text/javascript"></script> 
   @endsection