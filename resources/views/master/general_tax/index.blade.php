    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h2 class="pageheader-title">General Tax</h2>
            ...
            <div class="table-responsive">
              <table class="table data-table table-striped table-bordered first">
                ...
                <tbody> @foreach($data as $key => $value) <tr>
                    ...
                    <td>
                      <form action="/general-tax/{{ $value->id }}/delete" method="post"> @csrf 
...
<!-- MODAL --> 
 @include('master.general_tax._add') 
 @include('master.general_tax._edit') 
 @endsection 
