    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h2 class="pageheader-title">General Department</h2>
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          ...
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
              {{-- <a href="/general-department/index2"  class="btn btn-warning">list deleted</a> --}}
            ...
            <div class="table-responsive">
              <table class="table data-table table-striped table-bordered first">
                ...
                <tbody> @foreach($data as $key => $value) <tr>
                    ...
                    <td>
                      <form action="/general-department/{{ $value->id }}/delete" method="post" onsubmit="return confirm('Yakin ingin menghapus item ini?')"> @csrf 
...
<!-- MODAL --> 
 @include('master.general_department._add') 
 @include('master.general_department._edit') 
 @endsection 
