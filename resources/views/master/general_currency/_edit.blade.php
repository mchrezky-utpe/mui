<x-modals.modal id="edit_modal" title="Edit General Currency">
<form id="form_modal" autocomplete="off" class="form-horizontal" method="post" action="/general-currency/edit">
    @csrf
