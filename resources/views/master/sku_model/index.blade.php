    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
          <h2 class="pageheader-title">SKU Model</h2>
...
<!-- MODAL --> 
 @include('master.sku_model._add') 
 @include('master.sku_model._edit') 
 @endsection 
 
 @section('extra_javascript') 
 <script src="{{ asset('assets/js/master/sku_model.js') }}" type="text/javascript"></script> 
 @endsection