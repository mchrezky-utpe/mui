                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex">
                                <button id="add_button" type="button" class="btn btn-primary btn_part_information"
                                            ...
                                            <tbody>
                                                @foreach ($data as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($value->blob_image)
                                                                <img src="data:image/png;base64,{{ $value->blob_image }}"
                                                                    width="80" />
                                                            @else
                                                        ...
                                                        <td>
                                                            {{ $value->sku_procurement_type ? $value->sku_procurement_type : '-' }}
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <form action="/sku-part-information/{{ $value->id }}/delete"
                                                                method="post">
                                                                @csrf @method('DELETE')
                                                                <div class="d-flex">
...
@include('master.sku_part_information._edit') @endsection
