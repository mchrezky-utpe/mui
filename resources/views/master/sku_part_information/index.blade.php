                    ...
                    >
                        ...
                        <div class="d-flex">
                            <button
                                id="add_button"
                                type="button"
                                class="btn btn-primary btn_part_information"
                                data-toggle="modal"
                                ...
                                >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form
                                                    action="/sku-part-information/{{ $value->id }}/delete"
                                                    method="post"
                                                >
                                                    @csrf @method('DELETE')
                                                    <div class="d-flex">
...
<script
    src="{{ asset('assets/js/master/sku_part_information.js') }}"
