...
Route::controller(LoginController::class)->group(function () {
    Route::get("/login", "showLogin")->middleware(OnlyGuestMiddleware::class);
...
Route::controller(MasterSkuController::class)->group(function () {
    ...
    // API ALL
    Route::get("/api/sku-part-information", "api_part_information_all")->middleware(OnlyMemberMiddleware::class);
    Route::get("/api/sku-part-information-old", "api_sku_part_information")->middleware(OnlyMemberMiddleware::class);
