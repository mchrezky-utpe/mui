...
class MasterSkuService
{
    ...
    public function add(Request $request)
    {
        ...
        try {
            ...
            $data->group_tag = strtoupper($request->group_tag);
            ...
            $data->group_tag = strtoupper($request->group_tag);
            $data->specification_code = strtoupper($request->specification_code);
            $data->specification_detail = strtoupper($request->specification_detail);
