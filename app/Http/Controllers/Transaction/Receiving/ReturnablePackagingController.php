...
use App\Services\Transaction\Receiving\ReturnablePackagingService;
use Illuminate\Http\Request;
use Illuminate\Http\Response;

class ReturnablePackagingController
{

    private ReturnablePackagingService $service;

    public function __construct(ReturnablePackagingService $service)
    {
    ...
    public function receive(Request $request)
    {
        ...
        return redirect("/returnable-packaging");
    }
